...
<div class="modal fade" id="edit-hirarc-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form_hirarc_edit" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <i class="fa fa-book"></i> <b>DATA HIRARC</b>
                <div class="box-tools">
                    <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal"
                    data-target="#add-hirarc-modal">
                    <i class="fa fa-plus-circle"></i> Upload HIRARC
                </button>
            </div>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
    ...
    $('#form_hirarc_edit').on('submit', function (e) {
        e.preventDefault()
        $.ajax({
            type: 'post',
            url: "{!! url('hirarc/update') !!}",
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData: false,
