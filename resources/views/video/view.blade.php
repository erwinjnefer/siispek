        ...
        <div class="modal-content">
            <form id="form_video_edit" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Title</label>
                        <input type="text" id="e_title" class="form-control" name="title">
                    </div>
    ...
    <div class="col-md-12   ">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <i class="fa fa-book"></i> <b>DATA VIDEO</b>
                <div class="box-tools">
            ...
            <table width="100%" id="dataTable" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td>{{ $v->deskripsi }}</td>
                        <td>
                            <a href="{{ url($v->file) }}"><i class="fa fa-file-o"></i> {{ $v->file }}</a>
                        </td>
                        <td align="center">
                            <a href="#" data-id="{!! $v->id !!}" data-title="{!! $v->title !!}" data-deskripsi="{{ $v->deskripsi }}" class="btn btn-primary btn-sm btn-edit"><i
