...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Prosedur Kerja</li>
    </ol>
</section>
@endsection
@section('content')
...
<div class="modal fade" id="edit-pk-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form_pk_edit" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <i class="fa fa-book"></i> <b>DATA PROSEDUR KERJA</b>
                <div class="box-tools">
                    <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal"
                    data-target="#add-pk-modal">
                    <i class="fa fa-plus-circle"></i> Upload Prosedur Kerja
                </button>
            </div>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
    ...
    $('#form_pk_edit').on('submit', function (e) {
        e.preventDefault()
        $.ajax({
            type: 'post',
            url: "{!! url('prosedur-kerja/update') !!}",
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData: false,
    ...
    function del(id) {
        $.ajax({
            type: 'get',
            url: "{!! url('prosedur-kerja/delete?id=') !!}"+id,
            success: function (r) {
                console.log(r)
                if (r == 'success') {
                    Swal.fire(
