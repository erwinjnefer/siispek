...
<script>
    ...
    function init(){
        ...
        sos = @json($sos, JSON_PRETTY_PRINT);
        console.log(sos)
        // $.each(map_ref, function(i, d){
        //     // console.log(d)
        //     locations.push(
        //         [d.no_gardu, d.koordinat_y, d.koordinat_x]
        //         // [d.koordinat_y, d.koordinat_x]
        //     )
        // })
        var loc = sos.koordinat.split(",");
                console.log(loc)

    
        var map = L.map('map').setView([loc[0], loc[1]], 15);
